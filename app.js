...
class Tiles {
    constructor(dino) {
        this.animal = dino.species,
        this.dino = dino;
        this.image = "./images/" + dino.species.toLowerCase().split(" ").join(" ") + ".png";
    }
    ...
    compareName() {
        ...
        if (Name == this.dino.species) {
            ...
            return `Your name is ${Name.toLowerCase()} and the animal's name is ${this.animal}.`;
        }
    }
...
tiles.map(tile =>{   
    ...
    var weightFact = tile.compareWeight.call(tile, human);
    var heightFact = tile.compareHeight.call(tile, human);
    var nameFact = tile.compareName.call(tile, human);
    }
